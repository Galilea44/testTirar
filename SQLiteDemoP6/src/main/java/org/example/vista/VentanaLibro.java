...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(162, 162, 230));
        lblId= new JLabel("Id:");
        ...
        panel1.add(lblAutor);
        panel1.add(txtAutor);
        panel1.add(btbAgregar);

        //panel 2
        panel2 = new JPanel(new FlowLayout());
        panel2.setBackground(new Color(162, 230, 214));
        ...
        panel3.setBackground(new Color(239, 231, 184));

        //panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(232, 166, 210));
    ...
    public JButton getBtbAgregar() {
        return btbAgregar;
    }

    public void setBtbAgregar(JButton btbAgregar) {
        this.btbAgregar = btbAgregar;
    }
