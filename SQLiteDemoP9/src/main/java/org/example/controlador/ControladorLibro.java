...
public class ControladorLibro extends MouseAdapter {
    ...
    public ControladorLibro(VentanaLibro view) {
        ...
        this.view.getBtbAgregar().addMouseListener(this);
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(e.getSource()==this.view.getBtbAgregar()){
            ...
            if(modelo.agregarLibro(libro)){
                ...
                JOptionPane.showMessageDialog(view, "No se pudo agregar a la base de datos. Por favor revise su conexion", "Error al insetar", JOptionPane.ERROR_MESSAGE);
            }
            this.view.limpiar();
        }
    }
