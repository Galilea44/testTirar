...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(206, 238, 152, 255));
        lblId = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(182, 124, 196, 255));
        info = new ArrayList<>(); //le agrego un juego
        ...
        this.btnAgregar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                VideoJuego nuevo = new VideoJuego(); //llenamos el obj. nuevo con los datos de la vista
